...
<body class="">
	<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
		<div class="container-fluid">
			...
			<!-- Brand -->
			<a class="navbar-brand pt-0" href="<?php echo base_url();?>assets/index.html">
...
">
					...
					<div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
						...
						<a href="<?php echo base_url();?>assets/examples/profile.html" class="dropdown-item">
					...
					<div class="row">
						<div class="col-6 collapse-brand">
							<a href="<?php echo base_url();?>assets/index.html">
								<img src="<?php echo base_url();?>assets/assets/img/brand/blue.png">
							</a>
						</div>
          ...
          <a class=" nav-link " href=" <?php echo base_url();?>index.php/Project/"> <i class="ni ni-tv-2 text-primary">
						</i> Dashboard
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link " href="<?php echo base_url();?>index.php/Project/myproject">
							<i class="ni ni-planet text-blue"></i> My Project
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link " href="<?php echo base_url();?>index.php/Project_bid">
							<i class="ni ni-pin-3 text-orange"></i> Daftar Bidding
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link " href="<?php echo base_url();?>assets/examples/profile.html">
							<i class="ni ni-single-02 text-yellow"></i> My worker
						</a>
					</li>
					<!-- <li class="nav-item">
						<a class="nav-link " href="<?php echo base_url();?>assets/examples/tables.html">
							<i class="ni ni-bullet-list-67 text-red"></i> Tables
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="<?php echo base_url();?>assets/examples/login.html">
							<i class="ni ni-key-25 text-info"></i> Login
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="<?php echo base_url();?>assets/examples/register.html">
		...
		<nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
			<div class="container-fluid">
				...
				<a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block"
					href="<?php echo base_url();?>assets/index.html">Dashboard</a>
				<!-- Form -->
							...
							<div class="media align-items-center">
								<span class="avatar avatar-sm rounded-circle">
									<img alt="Image placeholder"
										src="<?php echo base_url();?>assets/assets/img/theme/team-4-800x800.jpg">
								</span>
	...
	<script src="<?php echo base_url();?>assets/assets/js/plugins/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
	<!--   Optional JS   -->
...
">
          ...
          <a class=" nav-link " href=" <?php echo base_url();?>index.php/Project/"> <i class="ni ni-tv-2 text-primary">
					...
					<li class="nav-item">
						<a class="nav-link " href="<?php echo base_url();?>index.php/Project/seeproject">
							<i class="ni ni-planet text-blue"></i> Cari Project
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link " href="<?php echo base_url();?>index.php/Project_bid">
							<i class="ni ni-pin-3 text-orange"></i> My Bidding
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link " href="<?php echo base_url();?>index.php/Project_bid">
...
">
          ...
          <a class=" nav-link " href=" <?php echo base_url();?>index.php/Project/"> <i class="ni ni-tv-2 text-primary">
					...
					<li class="nav-item">
						<a class="nav-link " href="<?php echo base_url();?>index.php/Project_bid">
							<i class="ni ni-pin-3 text-orange"></i> Project Bid
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link " href="<?php echo base_url();?>assets/examples/profile.html">
